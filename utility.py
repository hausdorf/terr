...
# victims white flags
one_list = ['ONE','TWO','SUSPECT','MAZA','STUDENT','MEMBER','CITIZENS','CITIZEN','EUROPEANS','POLICE','OTHER','A','RECTOR','JUDGES','JUDGE','US','COLOMBIANS','CHIEF','CHIEFS'] # ALSO ANY NUMBER BY ITSELF use isdigit function for string objects add all numbers + isdigit test
...
remove_list = ["GMT","APPROXIMATELY",",","ANTIDRUG","DECADES",'MONSIGNOR',"A","REPORTERS","MOUTH","ROUNDUPS","BEING","FIND","DETACHMENT","3D","MAGNATE","TELEVISION","WHICH","APPARENTLY","HOPEFUL","INCIDENT","KIDNAPPED","PRESIDENTIAL","CAN","35-YEAR-OLD","ANTI-TERRORIST","NOT","LED","NICARGUA","MISSING","MANY","DUE","INDISCRIMINATE","VENEZUELAN","ARE","SINCE","BLAME","BLAMED","BURIED","DECREES","DECREE","ISSUED","55-YEAR-OLD","PUNISHED","THOSE","RUMORS","MORE","GUARDING","SOURCES","POSITION","VACANT","SOURCE","ACCORDING","GIVEN","RESPITE","FEARS","AUGUST","DECADE","DECADED","BELIEVED","AWAKENING","VIOLENCE","PREVALENT","SEIZED","RIFLE","BEGINNING","REGIMES","TARGET","MR","UNDETERMINED","LARGE","PROPERTY","LOSSES","NEW","ACTIVITY","INSISTENT","IDENTIFIED","BOMBINGS","INCREASING","MURDERS","WAVE","KIDNAPPINGS","DRUG","TRAFFICKING","VERY","HOWEVER","ADMITS","ADMIT","FOUGHT","YOUNG","MECHANICS","SIMILAR","PRELIMINARY","LATER","MUCH","INVOLVED","LATE","MAY","DYNAMITE","ATTACK","CARRIED","OUT","CONSIDERING","ENOUGH","EVIDENCE","PROVE","MISTREATED","FIRST","BRIBED","STILL","MASSACRES","AMAZED","JUSTICE","MAGISTRATE","CANDIDATE","PAST","YEARS","PREVIOUS","ATTACKS","SERIOUSLY","NONE","CLAIMED","ME","TOOK","ACTION","ESCAPED","CLOSE","ATTENTION","REPORT","INCLUDE","MARCH","TAKEN","WAS","WARNING","PRESIDENCY","INDICATE","NEAR","VICTIMS","POLITICAL","FRIDAY","SALVADORAN","WAY","POLITICAL","MAIN","AUTHORITIES","AT","SAN","WELL","WORLD","GOVERNMENTS","RELEASE","TOTAL","CLARIFIACATION","PARTICULARLY","PARTICULAR","VICENTE","LOCATED","CLASHES","STRONG","VOLCANO","CHICHONTEPEC","0945","SOME","COULD","PARTICIPATED","IMMEDIATE","IDENTIKITS","AIRPORT","BOARD","FLIGHT","BETWEEN","HEADING","REPORTED","0630","0700","WOULD","ENTRANCE","COUNTRY","CENTRAL","GUATEMALA","REPORTS","COMPANION","ASSISTANT","SECRETARY","DEFENSE","MINISTER","CASE","COLD","BLOOD","ANOTHER","WE","TOTALLY","BEEN","BRUTALLY","VIOLENTLY","SHOTS","DAMAGED","DAMAGE","DURING","NO","OR","FROM","RESULTED","RESULT","CASUALTIES","SUBSTANTIALLY","BOMB","THE","THESE","OPERATIONS","KILLING","BEFORE","AFTER","DAY","SHOCKED","NATION","BOTH","MEMBER","PARTY","SOCIAL","DEMOCRATIC","CRIME","IT","HE","SHE","HIS","HER","HIM","THEY","THEM","TODAY","YESTERDAY","THIS","THAT","THERE","THEIR","WERE","ALSO","VICTIM","CAR","WHILE","FORMER","SAME","NIGHT","BY","AS","QUALIFICATIONS","WHO","KILLED","ALSO","HAVE","HAD","RECEIVED","RECEIVE","LEARNED","WE","SAME","PLACE","IN","MORNING","MURDERED","MASSACRED","'S","MASSACRE","MURDER","OUTSTANDING","GENERAL","LAST","TO","CONTINUE","HONEST"]

victim_remove_list = ["70,000","REPORTER","12","CAMP","DIRECTOR","WEEKEND","ARCE",'BATTALION',"DOWNTOWN","COMPANY","INFANTRY","CONCHAGUA","BATTALION","TOWN","MRTA","UCA","HUANTA","PALMEROLA","LEGISLATOR","UP","PRESIDENT","STREET","1210","PLANE","HOME","ARMY","ALL","GANGS","NEWSMEN","POLITICIANS","BASE","PALMORA","BROTHER","LOCAL","``","0030","CHRISTIAN","BUSINESSMAN","SPANISH","ELECTRIC","POWER","SUBSTATION","EUROPEAN","UNDER","9","HEAD","SUSPECTS","2","DEPARTMENT","FIRE","MAN","NATIONAL","GUERRILLAS","LIBERAL","MILITARY","SENATOR","BANKER","COLUMBIANS","GOVERNMENT","CANDIDATE","MAFIA","COLOMBIAN","3","MINISTRY","MEDIA","ITS","JUSTICE","ARMED","FORCES","DR","RESIDENCE","65","UNIVERSITY","RELIGIOUS","17","ORGANIZATION","TERRORIST","CAMERAMAN","POLICEMAN","ATTORNEY","CHILEAN","U.","S","HOSPITAL","18","BOMBS","ROSALES","37","OIL","PIPELINE","PACIFIC","ELN","10","TASS","MISSION","PERSON","VALUABLE","FOUND","BODY","BODIES","EL","SALVADOR","BORDER","GUATEMALAN","MSGR","11","DAYS","AGO","10","LABOR","MEDELLIN","BE","LEADERS","LEADER","LEFTIST","THREE","FOUR","FIVE","SIX","SEVEN","EIGHT","NINE","TEN","MNR","LA","AURORA","GROUP","GROUPS","OF","ON","AN","AREA","BOGOTA","1"]

target_remove_list = ["SAN","SALVADOR","BOMBS","JESUITS","CLERGYMEN","JESUIT","REBEL","POSITIONS","COLCANO","GROUP","OF"]

perp_indiv_remove_list = ["POLICE","BOMBS","GOVERNMENT","PEOPLE","LA","AURORA","PART"]
# REGEXES 
SEARCH_NP = "\[(.*?)\]\/NP" 
# NP cleaner 
